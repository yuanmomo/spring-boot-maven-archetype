...
public interface DemoMapper {
     ...
     * @mbg.generated
     */
    @Insert({ "insert into demo (number, version)", "values (#{number,jdbcType=INTEGER}, #{version,jdbcType=BIGINT})" })
     ...
     * @mbg.generated
     */
    @Select({ "select", "id, number, version", "from demo", "where id = #{id,jdbcType=BIGINT}" })
    @Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "number", property = "number", jdbcType = JdbcType.INTEGER), @Result(column = "version", property = "version", jdbcType = JdbcType.BIGINT) })
     ...
     * @mbg.generated
     */
    @Update({ "update demo", "set number = #{number,jdbcType=INTEGER},", "version = #{version,jdbcType=BIGINT}", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Insert({ "<script>", "insert into demo (number, ", "version)", "values<foreach collection=\"list\" item=\"detail\" index=\"index\" separator=\",\">(#{detail.number,jdbcType=INTEGER}, ", "#{detail.version,jdbcType=BIGINT})</foreach></script>" })
